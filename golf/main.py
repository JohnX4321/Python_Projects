...
import golf.physics as physics
import math

import golf.courses as courses

import golf.startScreen as startScreen
...
def onGreen():  # Determine if we are on the green
    ...
    for i in objects:
        ...
        if i[4] == 'green':
            ...
            if ballStationary[1] < i[1] + i[3] and ballStationary[1] > i[1] - 20 and ballStationary[0] > i[0] and \
                    ballStationary[0] < i[0] + i[2]:
...
while True:
    ...
    for event in pygame.event.get():
            ...
            for x in powerUpButtons:
                ...
                if pos[0] < x[0] + x[2] and pos[0] > x[0] - x[2] and pos[1] < x[1] + x[2] and pos[1] > x[1] - x[2]:
                    ...
                    if powerUps == 0:
                        ...
                        3] == 'M':  # Mullagain, allows you to retry your sot from your previous position, will remove strokes u had on last shot
        ...
        if event.type == pygame.MOUSEMOTION:  # Change the position of the angle line
            ...
            line = (
            round(ballStationary[0] + (math.cos(angle) * 50)), round(ballStationary[1] - (math.sin(angle) * 50)))
            ...
            for i in objects:  # for every object in the level
                ...
                if i[4] == 'coin':  # If the ball hits a coin
                    ...
                    if i[5]:
                        ...
                        if ballCords[0] < i[0] + i[2] and ballCords[0] > i[0] and ballCords[1] > i[1] and ballCords[1] < \
                                i[1] + i[3]:
                ...
                if i[4] == 'laser':  # if the ball hits the laser hazard
                    ...
                    if ballCords[0] > i[0] and ballCords[0] < i[0] + i[2] and ballCords[1] > i[1] and ballCords[1] < i[
                        1] + i[3]:
                        ballCords = shootPos
                    ...
                    if ballCords[1] > i[1] - 6 and ballCords[1] < i[1] + 8 and ballCords[0] < i[0] + i[2] and ballCords[
                        0] > i[0] + 2:
                    ...
                    if ballCords[1] > i[1] - 2 and ballCords[1] < i[1] + 7 and ballCords[0] < i[0] + i[2] and ballCords[
                        0] > i[0]:
                    ...
                    elif ballCords[1] < i[1] + i[3] and ballCords[1] > i[1] and ballCords[0] > i[0] - 2 and ballCords[
                        0] < i[0] + 10:
                    ...
                    elif ballCords[1] < i[1] + i[3] and ballCords[1] > i[1] and ballCords[0] > i[0] + i[2] - 16 and \
                            ballCords[0] < i[0] + i[2]:
                    ...
                    elif ballCords[1] > i[1] + i[3] and ballCords[0] + 2 > i[0] and ballCords[1] < i[1] + i[3] + 10 and \
